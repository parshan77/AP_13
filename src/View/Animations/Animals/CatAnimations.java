...
public class CatAnimations {
    private static final String pathToDirectory = "file:Textures\\Animals\\Cat\\";
    ...
    public static void upLeft(Group root, int startX, int startY, int finishX, int finishY) {
        MoveAnimation.upLeft(pathToDirectory, root, startX, startY, finishX, finishY, 24, 4, 6);
    }

    public static void upRight(Group root, int startX, int startY, int finishX, int finishY) {
        MoveAnimation.upRight(pathToDirectory, root, startX, startY, finishX, finishY, 24, 4, 6);
    }

    public static void downRight(Group root, int startX, int startY, int finishX, int finishY) {
        MoveAnimation.downRight(pathToDirectory,root,startX,startY,finishX,finishY,24,4,6);
    }

    public static void downLeft(Group root, int startX, int startY, int finishX, int finishY) {
        MoveAnimation.downLeft(pathToDirectory, root, startX, startY, finishX, finishY, 24, 4, 6);
    }
